...
exports.RoleGuard2 = void 0;
const common_1 = require("@nestjs/common");
const jwt_1 = require("@nestjs/jwt");
const core_1 = require("@nestjs/core");
const role_1 = require("../decorators/role");
let RoleGuard2 = class RoleGuard2 {
    ...
    canActivate(context) {
        try {
            const requiredRoles = this.reflector.getAllAndOverride(role_1.ROLE_KEY, [
                context.getHandler(),
                context.getClass(),
            ]);
            if (!requiredRoles) {
...
exports.RoleGuard2 = RoleGuard2;
exports.RoleGuard2 = RoleGuard2 = __decorate([
