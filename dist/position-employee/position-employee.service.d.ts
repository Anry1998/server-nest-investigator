...
export declare class PositionEmployeeService {
    ...
    issueEmployeePost(employeeId: number, postId: number): Promise<Employee>;
    deleteEmployeePost(employeeId: number, postId: number): Promise<Employee>;
    deleteAllEmployeePosts(employeeId: number): Promise<Employee>;
